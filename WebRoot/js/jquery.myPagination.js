(function ($) {
    $.fn.myPagination = function (param) {
        if (param && param instanceof Object) {
            ...
            var tempPage;
            var obj = $(this);
            var defaults = new Object({currPage: 1, pageCount: 10, pageSize: 5, cssStyle: 'badoo', ajax: {on: false, hiddenId: 'pageCount', param: {on: false, page: 1}}, info: {first: '首页', last: '尾页', next: '下一页', prev: '上一页', first_on: true, last_on: true, next_on: true, prev_on: true, msg_on: true, link: '#', msg: '<span>&nbsp;&nbsp;跳{curr}/{sum}页</span>', text: {width: '22px'}}});
